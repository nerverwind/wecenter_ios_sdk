...
class explore extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		{
			$posts_list = $this->model('posts')->get_hot_posts(null, $category_info['id'], $topic_id, $_GET['day'], $_GET['page'],$per_page);
		}
		else
		{
			$posts_list = $this->model('posts')->get_posts_list(null, $_GET['page'], $per_page, $_GET['sort_type'], $topic_id, $category_info['id'], $_GET['answer_count'], $_GET['day'], $_GET['is_recommend']);
		}
