	...
	public function index_action()
	{
		...
		if ($_GET['column'] != 'log')
		{
			...
			else
			{
                ...
                $answer_list = $this->model('answer')->get_answer_list_by_question_id($question_info['question_id'], calc_page_limit($_GET['page'], $per_page), $answer_list_where, $answer_order_by);
			}
